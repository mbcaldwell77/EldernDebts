  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 transition-smooth">
      <div className="glass-card rounded-card-lg shadow-elegant-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto transition-smooth">
        <div className="p-10">
          <h2 className="font-display text-5xl font-bold mb-3 tracking-wide text-[#10b981]">Welcome to Ældern Debts</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full glass-card rounded-card px-5 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#10b981]/50 transition-smooth"
                ...
                <button
                  ...
                  className="w-full bg-[#10b981] hover:bg-[#14b8a6] rounded-full px-6 py-3 font-semibold text-white transition-smooth shadow-lg shadow-[#10b981]/30 hover:shadow-[#10b981]/50"
                >
                  Add Debt
                </button>
              </div>
              ...
              <div className="flex gap-4 mt-8">
                ...
                <button
                  ...
                  className="ml-auto px-8 py-3 bg-[#10b981] hover:bg-[#14b8a6] rounded-full font-semibold text-white transition-smooth shadow-lg shadow-[#10b981]/30 hover:shadow-[#10b981]/50 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Next: Preferences
                </button>
              </div>
          ...
          {step === 2 && (
            <div className="space-y-6">
              ...
              <div className="flex gap-4 mt-8">
                ...
                <button
                  onClick={() => setStep(3)}
                  className="ml-auto px-8 py-3 bg-[#10b981] hover:bg-[#14b8a6] rounded-full font-semibold text-white transition-smooth shadow-lg shadow-[#10b981]/30 hover:shadow-[#10b981]/50"
                >
                  Next: Review
                </button>
              </div>
